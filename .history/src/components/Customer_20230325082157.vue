  ...
  <div class="container-fluid">
    <div class="row">
      <div class="search-form">
        <!-- <button @click="showFormSearch = !showFormSearch">{{ showFormSearch ? 'Hide Form' : 'Show Form' }}</button> -->
        <button data-toggle="minimize" @click="showFormSearch = !showFormSearch">{{ showFormSearch ? 'Hide Form' : 'Show Form' }}</button>
