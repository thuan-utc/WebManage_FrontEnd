<template>
  ...
  <div class="container-fluid">
    <div class="row">
      <div>
        <button id="toggle" @click="showFormSearch = !showFormSearch">{{ showFormSearch ? 'Hide search box' : 'Showsearch'}}</button>
          ...
          <form>
            <div class="container-fluid">
              <div class="row">
                <div class="col-lg-3">
                  <label>ID</label>
                  <input type="text" class="form-control search" placeholder="id">
                </div>
                <div class="col-lg-3">
                  <label>Name</label>
                  <input type="text" class="form-control search" placeholder="name">
                </div>
                <div class="col-lg-3">
                  <label>Phone</label>
                  <input type="text" class="form-control search" placeholder="phone">
                </div>
                <div class="col-lg-3">
                  <label>Email</label>
                  <input type="text" class="form-control search" placeholder="email">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-lg-3">
                  <label>Address</label>
                  <input type="text" class="form-control search" placeholder="address">
                </div>
                <div class="col-lg-3">
                  <label>Created Date</label>
                  <input type="date" class="form-control search" placeholder="date">
                </div>
                <div class="col-lg-1" style="margin-top: 10px;">
                  <button type="submit" class="btn btn-info">Search</button>
                </div>
                <div class="col-lg-1">
                  <button type="reset" style="margin-top: 10px;" class="btn btn-success">Reset</button>
                </div>
              </div>
            </div>
