<template>
  ...
  <div class="container-fluid">
    <div class="row">
      <div>
        <button id="toggle" @click="showFormSearch = !showFormSearch">{{ showFormSearch ? 'Hide search box' : 'Show search' }}</button>
        <div v-show="showFormSearch" class="search-form">
        <form>
          <label for="Id">ID</label>
            <input type="text"  placeholder="Id" v-model="selectedRow.id">
        </form>
      </div>
    </div>
    </div>
...
#detail-information, .search-form {
